...
<body>
	...
	<!-- end of nav <-->
	    	...
	    	<div class="row container-fluid">
	    		<center>
	    			<h2 class="text-center mt-2" style="color: #B92533;">Registeration Form</h2><hr/>
					<fieldset>
							...
							<table>
								...
								<tr >
									...
									<td style="padding-top: 10px; " >
										<input style="background-color:#B92533; color: white" type="submit" name="register" value="Register" onclick="return register_form()">
									</td>
								</tr>
							</table>
						</form>
